...
def restore_mongodb_dataset(uri: str, database_name: str, collection_name: str, input_file: posixpath):
    # Connect to MongoDB
...
if __name__ == "__main__":
    ...
    # Input file
    input_file_account = os.path.join("data_tp3/accounts.bson")
    input_file_transers = os.path.join("data_tp3/transfers.bson")
